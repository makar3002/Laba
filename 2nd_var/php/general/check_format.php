    ...
    switch ($type) {
        ...
        case 'date': // проверка на дату формата уууу-мм-дд
            if (mb_strlen($data) == 10){
                ...
                if (strlen($year.$month.$day) == strlen((int)$year.$month.$day)){ //если приведение типов не уменьшило количество символов в конкатинации всех трех величин, значит, они все натуральные числа
