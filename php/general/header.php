<header class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 border-bottom page-header">
    ...
    <div class="my-md-0 ml-md-auto d-flex align-items-center">
        <form action="/search.php" method="get" class="form-inline mx-2" enctype="application/x-www-form-urlencoded">
            <input name="request" class="form-control" type="text" placeholder="Поиск" aria-label="Search" required>
