...
<body>
	...
	<?php if (isset($_SESSION['user_id'])) {?>
		...
		<button type="button" class="btn btn-primary position-relative p-3" data-toggle="modal" data-target="#exampleModalCenter">
		  Добавить в журнал
		</button>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="journal_modal_form.php" class="form" method = "post" id = "form">
